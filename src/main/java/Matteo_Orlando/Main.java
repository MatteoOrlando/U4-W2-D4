...
public class Main {
    public static void main(String[] args){
        ...
        //raggruppamento ordini cliente tramite lambda/stream
        Map<Customer, List<Order>> ordersByCustomer = orders.stream()
                .collect(Collectors.groupingBy(Order::getCustomer));

        //stampo a video il ris.
    ...
    public static void createCustomers() {
        ...
        Customer customer1 = new Customer("NomeCliente1", 1);
        Customer customer2 = new Customer("NomeCliente2", 2);
        // Aggiunta dei clienti alla lista
